...
def integral_crude_MC(funzione, M, m, N_eve):                # si basa sul teorema della media secondo il quale l'integrale è pari al valor medio della funzione per l'ampiezza dell'intervallo
